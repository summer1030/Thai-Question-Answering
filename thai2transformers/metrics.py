...
def question_answering_metrics(datasets,
    ...
    if save_predictions:
        ...
        with open('./predictions/predictions_{}.json'.format(suffix),'w') as fp:
            json.dump(formatted_predictions,fp)

        with open('./predictions/references_{}.json'.format(suffix),'w') as fr:
            json.dump(references,fr)
