...
Combine the training data from the following three datasets,
...
xquad = load_dataset('zhufy/xquad_split')
...
thaiqa2_contexts = set(thaiqa2['validation']['context'])
xquad2_contexts = set(xquad2['validation']['context']+ xquad2['test']['context'])
...
datasets= copy.deepcopy(iapp)

datasets['train'] = concatenate_datasets([iapp['train'],thaiqa3['train'],xquad3['train']])
datasets['validation'] = concatenate_datasets([iapp['validation'],thaiqa3['train'],xquad3['validation']])
datasets['test'] = iapp['test']
